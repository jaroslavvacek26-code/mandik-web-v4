      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <div className="rounded-xl overflow-hidden border border-gray-200 shadow-md">
            <div className="aspect-video">
              <iframe
                src="https://www.youtube.com/embed/SX05F-NoZJ8"
                title="MANDÍK a.s. – firemní film"
        ...
        <section>
          ...
          <div className="relative">
            {/* Svislá čára vlevo */}
            <div className="absolute left-5 sm:left-7 top-0 bottom-0 w-0.5 bg-gray-200" />
            ...
            <div className="space-y-0">
              {sorted.map((milestone, index) => (
                ...
                >
                  {/* Tečka na timeline */}
                  <div className="shrink-0 w-10 sm:w-14 flex justify-center pt-5 relative z-10">
                  ...
                  {/* Karta */}
                  <div className="flex-1 pb-7 pt-2">
                    <div className="bg-white border border-gray-100 border-t-4 border-t-brand-green rounded-lg p-5 sm:p-6 hover:shadow-md hover:border-brand-green/30 transition-all">
